...
class PopoverRuntime {
  constructor(element) {
    ...
    this.portal = new OverlayPortal(this.trigger, this.content, { offset: 8, matchAnchorWidth: false, align: "center", onRequestClose: () => this.close() });
  ...
  destroy() { this.close(); this.portal.destroy(); this.trigger.removeEventListener("click", this.onClick); instances.delete(this.element); }
}
