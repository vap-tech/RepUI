...
Грамматики Highlight.js подключаются как ES-модули из CDN: Django/Jinja,
HTML/XML, CSS, JavaScript, JSON и Python.
...
- [ ] При доступном CDN подсветка Django-тегов, HTML и JavaScript работает.
